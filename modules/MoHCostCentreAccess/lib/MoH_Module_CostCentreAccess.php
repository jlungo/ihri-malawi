...
class MoH_Module_CostCentreAccess extends I2CE_ModuleAccess {
    ...
    public function userAccessFacility($node,$template) {
        // This should only work for the hr_officer role so ignore any others.
        if ( $template->getUser()->getRole() != "hr_officer" ) {
            return false;
        }
